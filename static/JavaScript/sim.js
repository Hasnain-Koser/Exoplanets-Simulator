...
var controlsh3 = document.getElementById('controls');
var showControls = true;
controlsh3.onclick = () => {
    var divs = document.getElementsByClassName('ui')[0].getElementsByTagName('div');
    ...
    controlsh3.getElementsByTagName('i')[ 0 ].className = !showControls ? "fa fa-solid fa-angle-down" : "fa fa-solid fa-angle-right";
    showControls = !showControls;
}

var datah3 = document.getElementById('data');
var showData = true;
datah3.onclick = () => {
    var divs = document.getElementsByClassName('data')[0].getElementsByTagName('div');
    for (i = 0; i < divs.length; i++) {
        if (showData) {
            divs[ i ].style.display = 'none';
        } else {
    ...
    datah3.getElementsByTagName('i')[ 0 ].className = !showData ? "fa fa-solid fa-angle-down" : "fa fa-solid fa-angle-right";
    showData = !showData;
}
...
class Planet {
    ...
    attachlabel(advancedTexture, setcam) {
        ...
        this.rect1.onPointerClickObservable.add(() => {
            var optionValue = this.plname + " (Planet)";
            document.getElementById("planet").value = optionValue;
            setcam();
        });
...
class Star {
    ...
    attachlabel(advancedTexture) {
        ...
        this.rect1.isPointerBlocker = true;
        this.rect1.onPointerClickObservable.add(() => {
            var optionValue = this.stname + " (Star)";
            document.getElementById("planet").value = optionValue;
            setcam();
        });
...
function main(canvas, engine){
    ...
    var createScene = function() {
        ...
        document.getElementById("planet").onchange = setcam
        function showpldata () {
        ...
        for(planet=0; planet < pl_bodies.length; planet++) {
            pl_bodies[planet].attachlabel(advancedTexture, setcam);
        }
        star.attachlabel(advancedTexture, setcam)
